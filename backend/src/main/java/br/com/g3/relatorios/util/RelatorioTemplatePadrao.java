  ...
  public static String buildHtml(
    ...
    String htmlTemplate =
        "<!DOCTYPE html>\n"
            ...
            + "      .presenca-course-name { font-size: 16px; font-weight: 700; }\n"
            ...
            + "      .print-table--espelho { table-layout: fixed; font-size: 9.5px; }\n"
            + "      .print-table--espelho th, .print-table--espelho td { padding: 4px 6px; word-break: break-word; }\n"
            + "      .print-table--espelho th:nth-child(1), .print-table--espelho td:nth-child(1) { width: 7%%; }\n"
            + "      .print-table--espelho th:nth-child(2), .print-table--espelho td:nth-child(2) { width: 10%%; }\n"
            + "      .print-table--espelho th:nth-child(3), .print-table--espelho td:nth-child(3) { width: 6%%; }\n"
            + "      .print-table--espelho th:nth-child(4), .print-table--espelho td:nth-child(4) { width: 6%%; }\n"
            + "      .print-table--espelho th:nth-child(5), .print-table--espelho td:nth-child(5) { width: 6%%; }\n"
            + "      .print-table--espelho th:nth-child(6), .print-table--espelho td:nth-child(6) { width: 6%%; }\n"
            + "      .print-table--espelho th:nth-child(7), .print-table--espelho td:nth-child(7) { width: 7%%; }\n"
            + "      .print-table--espelho th:nth-child(8), .print-table--espelho td:nth-child(8) { width: 7%%; }\n"
            + "      .print-table--espelho th:nth-child(9), .print-table--espelho td:nth-child(9) { width: 7%%; }\n"
            + "      .print-table--espelho th:nth-child(10), .print-table--espelho td:nth-child(10) { width: 9%%; }\n"
            + "      .print-table--espelho th:nth-child(11), .print-table--espelho td:nth-child(11) { width: 29%%; }\n"
            + "      .print-table--espelho { table-layout: fixed; font-size: 9.5px; }\n"
            + "      .print-table--espelho th, .print-table--espelho td { padding: 4px 6px; word-break: break-word; }\n"
            + "      .print-table--espelho th:nth-child(1), .print-table--espelho td:nth-child(1) { width: 7%%; }\n"
            + "      .print-table--espelho th:nth-child(2), .print-table--espelho td:nth-child(2) { width: 7%%; }\n"
            + "      .print-table--espelho th:nth-child(3), .print-table--espelho td:nth-child(3) { width: 6%%; }\n"
            + "      .print-table--espelho th:nth-child(4), .print-table--espelho td:nth-child(4) { width: 6%%; }\n"
            + "      .print-table--espelho th:nth-child(5), .print-table--espelho td:nth-child(5) { width: 6%%; }\n"
            + "      .print-table--espelho th:nth-child(6), .print-table--espelho td:nth-child(6) { width: 6%%; }\n"
            ...
            + "      .print-table--espelho th:nth-child(9), .print-table--espelho td:nth-child(9) { width: 7%%; }\n"
            + "      .print-table--espelho th:nth-child(10), .print-table--espelho td:nth-child(10) { width: 9%%; }\n"
            + "      .print-table--espelho th:nth-child(11), .print-table--espelho td:nth-child(11) { width: 32%%; }\n"
            + "      .print-table th { width: 28%%; background: #f3f4f6; }\n"
            + "      .print-table--presenca { table-layout: fixed; }\n"
            + "      .print-table--presenca .col-num { width: 4%%; text-align: center; }\n"
            + "      .print-table--presenca .col-nome { width: 34%%; }\n"
            + "      .print-table--presenca .col-cpf { width: 18%%; }\n"
            + "      .print-table--presenca .col-presente, .print-table--presenca .col-ausente { width: 7%%; text-align: center; }\n"
            + "      .print-table--presenca .col-assinatura { width: 30%%; }\n"
            + "      .print-table--presenca-sem-cpf .col-nome { width: 44%%; }\n"
            + "      .print-table--presenca-sem-cpf .col-presente, .print-table--presenca-sem-cpf .col-ausente { width: 8%%; }\n"
            + "      .print-table--presenca-sem-cpf .col-assinatura { width: 36%%; }\n"
            + "      .section { margin-bottom: 16px; }\n"
            + "      .espelho { margin-top: 6mm; }\n"
            + "      .espelho__spacer { height: 6mm; }\n"
            + "      .espelho__meta { margin-bottom: 12px; padding-top: 4mm; }\n"
            + "      .signature { display: flex; gap: 32px; margin-top: 24px; }\n"
            + "      .signature--espelho { margin-top: 40px; }\n"
            + "      .signature__line { flex: 1; border-top: 1px solid #111827; padding-top: 16px; min-height: 80px; }\n"
            + "      .espelho__signature-spacer { height: 24mm; }\n"
